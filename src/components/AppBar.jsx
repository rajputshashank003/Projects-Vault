...
const AppBar = () => {
    ...
    return (
        <div data-scroll data-scroll-speed={'0.03'} ref={par} className='sm:mx-[5%] max-sm:mx-[8px] h-[42px] md:h-[62px] shadow-[0px_0px_4px] shadow-red-800/30 sticky top-[32px] sm:top-[12px] z-[999] rounded-[12px] overflow-hidden'>
