...
const WebThree = () => {
    ...
    return (
        <div className='min-h-screen relative justify-start'>
            <div onClick={() => navigate("/")} className="absolute font-sans flex flex-row gap-2 justify-start items-start right-2 sm:right-10 top-2 sm:top-10 text-zinc-400 cursor-pointer z-[9999] hover:scale-125 duration-300 font-bold">
